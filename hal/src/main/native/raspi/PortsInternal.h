...
/* NOTE:  These values need to be synchronized with the Raspi Channel Map.  It is possible in the future */
/*        that these values will be dynamic (based upon the current Raspi Channel Map.                   */
