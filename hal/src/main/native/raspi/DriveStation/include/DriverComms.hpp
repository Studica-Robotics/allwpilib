...
#define RASPI_COMMS_SHUTDOWN_NONE		0
#define RASPI_COMMS_SHUTDOWN_ESTOP 	    1
#define RASPI_COMMS_SHUTDOWN_REBOOT	    2
#define RASPI_COMMS_SHUTDOWN_RESTART  	3

#define RASPI_COMMS_STATE_DISABLED	    0
#define RASPI_COMMS_STATE_AUTONOMOUS	1
#define RASPI_COMMS_STATE_TELEOP		2
#define RASPI_COMMS_STATE_TEST		    3
...
namespace raspi {
    namespace comms {
        ...
        void stop();
        int decodeUdpPacket(char* data, int length); // returns RASPI_COMMS_SHUTDOWN_XXX code
	...
	void setRobotState(uint8_t mode /*RASPI_COMMS_STATE_xxx*/);
