...
public class AHRSJNI {
  ...
  public static native boolean BlockOnNewCurrentRegisterData(
      int timeout_ms,
  ...
  public static native boolean ReadConfigurationData(
      byte first_reg, byte[] data_out, byte requested_len);
}
