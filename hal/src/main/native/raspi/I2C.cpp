...
void HAL_InitializeI2C(HAL_I2CPort port, int32_t* status) {
	...
	VMXChannelInfo i2c_channels[2] = { { VMXChannelInfo(
			raspi::vmxIO->GetSoleChannelIndex(VMXChannelCapability::I2C_SDA),
			VMXChannelCapability::I2C_SDA) }, { VMXChannelInfo(
			raspi::vmxIO->GetSoleChannelIndex(VMXChannelCapability::I2C_SCL),
			VMXChannelCapability::I2C_SCL) } };

	I2CConfig i2c_cfg;

	if (!raspi::vmxIO->ActivateDualchannelResource(i2c_channels[0], i2c_channels[1],
...
int32_t HAL_TransactionI2C(HAL_I2CPort port, int32_t deviceAddress,
	...
	if (raspi::vmxIO->I2C_Transaction(vmx_res_handle,
...
int32_t HAL_WriteI2C(HAL_I2CPort port, int32_t deviceAddress,
	...
	if (raspi::vmxIO->I2C_Write(vmx_res_handle,
